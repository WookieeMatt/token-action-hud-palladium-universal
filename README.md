...
| **Skills** | Every skill with its percentage. (Attributes are not on the HUD: they are not rolled in play.) |
...
**Right-click** a weapon, skill, spell, power or item to open it. With **several tokens selected**, combat rolls and saves roll for each of them.
